...
set colorcolumn=80,100     "Highlight columns 80 and 100
...
set autoread	    " Autoread when file is changed from another source.
...
" Enable detection of filetype and activate associated settings
filetype plugin indent on
syntax on

" Keep my plugin settings in a different file for cleanliness
source ~/.vim/plugins.vim

" NOTE: Color scheme must be after sourcing plugins.vim because we install
